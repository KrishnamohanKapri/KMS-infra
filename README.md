...
> **Note:** The diagrams below use Mermaid syntax and will render as visual diagrams on GitHub. If you're viewing this in an IDE that doesn't support Mermaid, you can view the rendered version on GitHub or use the text-based diagrams provided below.

### High-Level Architecture

**Visual Diagram (Mermaid - renders on GitHub):**
...
**Text-Based Diagram (works everywhere):**

```
┌─────────────────────────────────────────────────────────────────┐
│                    KMS Infrastructure (This Repo)                │
│                                                                   │
│    ┌──────────┐                                                 │
│    │ Terraform│                                                 │
│    └────┬─────┘                                                 │
...
└──────────────────────────────────┼──────────────────────────────┘
                    ...
                    │                       │
        ┌───────────▼──────┐  ┌────────────▼──────┐
        │ KMS-app Backend  │  │ KMS-app Frontend  │
        └──────────────────┘  └───────────────────┘
```
...
**Text-Based Flow (works everywhere):**
...
Ansible
    ...
    ├──► Configure kubectl ────────┐
    ├──► Create Namespaces ─────────┤
    ├──► Install Argo CD ───────────┤──► Kubernetes Cluster
    ├──► Install Gateway API ───────┤
    └──► Deploy GitOps Apps ────────┘
    │
    │
...
KMS-gitops
    │
    ├──► Deploy KMS Backend ────────┐
    ├──► Deploy KMS Frontend ───────┤──► Kubernetes Cluster
    └──► Deploy MongoDB ─────────────┘
```
...
└──────────────────────┼──────────────────────────────────────┘
                       ...
                       ▼
┌─────────────────────────────────────────────────────────────┐
│          Infrastructure (KMS-infra - This Repo)              │
│                                                              │
│  Terraform + Ansible                                        │
│         │                                                    │
│         ▼                                                    │
...
│                    GitOps (KMS-gitops)                      │
│                                                              │
│  K8s Manifests ──────► Argo CD ──────► Kubernetes Cluster │
└─────────────────────────────────────────────────────────────┘
          │
          │ Deploys
          ▼
┌─────────────────────────────────────────────────────────────┐
│         KMS Application Running in Production ✅              │
└─────────────────────────────────────────────────────────────┘
```
